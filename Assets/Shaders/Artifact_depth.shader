Shader "Helliaca/Artifact_depth"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fragmentOutput frag(v2f i)
            {
                ...
                // Get the position where our ray hit (in world coords) and transform it into clip space
                float4 clip_pos = mul(UNITY_MATRIX_VP, float4(og_ori + og_dir * t, 1.0));
